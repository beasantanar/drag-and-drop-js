...
Este é o projeto de número 1, que traz um relógio analógico que é atualizado em tempo real.traz uma bateria que funciona via teclado, onde as teclas específicas possuem um som distinto.
...
```bash
# Clone o projeto
$ git clone https://github.com/beasantanar/drum-js
...
# O projeto será iniciado em <http://127.0.0.1:5500/drum-js/index.html>
```
